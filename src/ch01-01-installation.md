...
## Rust is supported on some of the most popular IDE’s

After installing Rust, depending on your IDE and code editor, extensions can be added to allow for Rust error handling. Rust extension support can be found on some of the most popular IDE’s including those by Microsoft, JetBrains, Apache, and Eclipse.
